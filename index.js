...
*/
console.log(reviews.push({name: 'Emil',rating: 5,feedback:'Perfect restaurant'}));
...
console.log(addMissing(reviews));
...
function carMaker(odometer) {
 const car = {
   ...
   drive: function (distance){
     return this.driven = this.driven + distance;
   }
 }
 car.drive(100);
 return car;
